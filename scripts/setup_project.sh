...
echo -e "${BLUE}📚 Ebook Generation Engine - Project Setup${NC}"
echo ""
...
Copyright © $BOOK_DATE by $BOOK_PUBLISHER
...
book:
  ...
  rights: "Copyright © $BOOK_DATE by $BOOK_PUBLISHER. All rights reserved."
